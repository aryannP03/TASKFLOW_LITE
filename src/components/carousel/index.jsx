...
function Customcarousel() {
  ...
  const getStyle = (index) => {
    ...
    // show only 1 card on each side
    if (absOffset > 2) {
      return { opacity: 0, pointerEvents: "none" };
    }

    return {
      transform: ` translateX(${offset * 180}px) scale(${1 - absOffset * 0.09}) rotateY:(${offset * -12}deg)  `,
  ...
  return (
    <div className="relative h-[400px] mt-5 flex items-center justify-center [prespective-1000px]">
